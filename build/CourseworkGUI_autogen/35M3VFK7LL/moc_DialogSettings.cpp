...
#include "../../../gui/include/DialogSettings.h"
...
template <> constexpr inline auto DialogSettings::qt_create_metaobjectdata<qt_meta_tag_ZN14DialogSettingsE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'addCardioExercise'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'removeCardioExercise'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'addUpperExercise'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'removeUpperExercise'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'addLowerExercise'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'removeLowerExercise'
...
void DialogSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->addCardioExercise(); break;
        case 1: _t->removeCardioExercise(); break;
        case 2: _t->addUpperExercise(); break;
        case 3: _t->removeUpperExercise(); break;
        case 4: _t->addLowerExercise(); break;
        case 5: _t->removeLowerExercise(); break;
        default: ;
        }
    }
    (void)_a;
