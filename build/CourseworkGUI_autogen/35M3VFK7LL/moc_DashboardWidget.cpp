...
#include "../../../gui/include/DashboardWidget.h"
...
void DashboardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->requestViewPlan(); break;
        case 2: _t->requestAddMeasurement(); break;
        case 3: _t->onGeneratePlan(); break;
        case 4: _t->onViewPlan(); break;
        case 5: _t->onAddMeasurement(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DashboardWidget::*)()>(_a, &DashboardWidget::requestGeneratePlan, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DashboardWidget::*)()>(_a, &DashboardWidget::requestViewPlan, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (DashboardWidget::*)()>(_a, &DashboardWidget::requestAddMeasurement, 2))
            return;
    }
}
...
// SIGNAL 0
void DashboardWidget::requestGeneratePlan()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DashboardWidget::requestViewPlan()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void DashboardWidget::requestAddMeasurement()
{
