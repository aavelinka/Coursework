...
#include "../../../gui/include/SettingsWidget.h"
...
void SettingsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onExportData(); break;
        case 3: _t->onBackupData(); break;
        case 4: _t->onChangeUnits(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsWidget::*)()>(_a, &SettingsWidget::profileUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void SettingsWidget::profileUpdated()
{
